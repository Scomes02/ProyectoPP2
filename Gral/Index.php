            ...
            <form>
                <div class="botones">
					<div class="boton-contenedor">
						...
						<a type="submit" href="../Cliente/InicioCliente.php" class="styled-button">Cliente</a>
					</div>
					<div class="boton-contenedor">
                        <img src="../img/Comercios.png" alt="Imagen de Comercios" class="imagen-boton">
                        <a type="submit" href="../Comercio/InicioComercio.php" class="styled-button">Comercio</a>
                    </div>
                </div>
				<br>
